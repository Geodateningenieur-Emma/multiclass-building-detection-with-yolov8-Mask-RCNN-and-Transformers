...
# Example usage
input_folder = 'C:/dl/maskformer/mtformer/input/labels'  # Path to your input TIFF images folder
output_folder = 'C:/dl/maskformer/mtformer/input/masks'  # Path where you want to save the PNG images
